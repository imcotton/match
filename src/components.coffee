    ...
    Calculate: class Calculate
        ...
        hasMatch: (foo, bar) ->
            ...
            [foo, bar] = for item in [foo, bar]
                item.gets components.Point, components.Range
        ...
        markMatch: (cell) ->
            ...
            state = cell.get components.State
            state.done = true

            range = cell.get components.Range
        ...
        getCellRange = (grid, cell) ->
            ...
            point = cell.get components.Point
            range = cell.get components.Range
            ...
            for key, value of list
                list[key] = value?.get components.Range
